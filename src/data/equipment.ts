...
export const equipmentGroups: EquipmentGroup[] = [
	{
		...
		items: [
			item('ota', '01', { ca: 'OTA principal', es: 'OTA principal', en: 'Main OTA' }, { ca: 'Captura principal', es: 'Captura principal', en: 'Main capture' }, { ca: 'Tub òptic principal de captura', es: 'Tubo óptico principal de captura', en: 'Main optical tube for image capture' }, { ca: 'ota-principal', es: 'ota-principal', en: 'main-ota' }, {
				...
				imageAlt: { ca: 'OTA principal amb les cintes calefactores del tub principal i del tub de guiatge, i la sonda de temperatura instal·lada al lateral', es: 'OTA principal con las cintas calentadoras del tubo principal y del tubo de guiado, y la sonda de temperatura instalada en el lateral', en: 'Main OTA with heater bands on the main and guide scopes, and the temperature probe attached to its side' },
				description: {
					ca: 'La fotografia mostra l’OTA principal integrat en el conjunt de captura. Al voltant de la zona davantera del tub es veu la cinta calefactora principal, mentre que una segona cinta protegeix el tub de guiatge. Al lateral de l’OTA hi ha instal·lada la sonda de temperatura que proporciona la referència ambiental al sistema de control anticondensació. Tot i formar part de l’alimentació i el control ambiental, aquests petits elements es documenten aquí perquè la seva ubicació sobre els tubs òptics explica millor la seva funció i no necessiten una fitxa fotogràfica pròpia.',
					es: 'La fotografía muestra la OTA principal integrada en el conjunto de captura. Alrededor de la zona delantera del tubo se aprecia la cinta calentadora principal, mientras que una segunda cinta protege el tubo de guiado. En el lateral de la OTA está instalada la sonda de temperatura que proporciona la referencia ambiental al sistema de control anticondensación. Aunque forman parte de la alimentación y el control ambiental, estos pequeños elementos se documentan aquí porque su ubicación sobre los tubos ópticos explica mejor su función y no necesitan una ficha fotográfica propia.',
