...
export const copy = {
	ca: {
		...
		home: 'Inici', catalogue: 'Galeria', myEquipment: 'El meu equip', all: 'Tots', backHome: 'Tornar a la portada', backCatalogue: 'Tornar a la galeria',
	...
	es: {
		...
		home: 'Inicio', catalogue: 'Galería', myEquipment: 'Mi equipo', all: 'Todas', backHome: 'Volver a la portada', backCatalogue: 'Volver a la galería',
	...
	en: {
		...
		home: 'Home', catalogue: 'Gallery', myEquipment: 'My equipment', all: 'All', backHome: 'Back to the home page', backCatalogue: 'Back to the gallery',
